...
public class HomeVideoData {
    ...
    public HomeVideoData(String name, String position, Drawable userImge, Drawable postImge, String likeCount, String shareCount, String commentCount, String likeName, String postDescription) {
        this.name = name;
        this.position = position;
        this.userImge = userImge;
        this.postImge = postImge;
